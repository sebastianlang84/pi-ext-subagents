...
- Clarify and test `cwd` semantics: agent discovery stays rooted at Pi's current workspace, while single/parallel/chain execution uses each requested run `cwd` when provided. SemVer: patch.
