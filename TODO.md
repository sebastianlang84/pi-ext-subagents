...
1. [ ] Deepen project-agent trust diagnostics.
...
2. [ ] Explore optional fanout-then-reduce orchestration.
...
4. [ ] Add a prompt-injection effectiveness test for subagent routing.
...
5. [ ] Improve README with advanced workflow recipes.
...
6. [ ] Consider moving task prompts out of process argv.
